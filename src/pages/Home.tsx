      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 py-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-10 max-w-3xl mx-auto leading-relaxed">
            Ask questions in natural language. Get instant answers about your team's
            performance, commits, and projects. Transform data into insights.
          </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  Query your engineering data using natural language. No complex dashboards or SQL queries
                  needed. Just ask a question and get instant, accurate answers.
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Ask questions in plain English, get intelligent answers</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Watch the AI think and respond in real-time</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">AI understands your team, repos, and Jira context</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm mb-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600">"Who had the most commits last month?"</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-accent/5 border border-accent/20 rounded-xl p-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700 text-sm">Based on commit analysis, <strong>Sarah Chen</strong> had the most commits last month with <strong>47 commits</strong>. Her average grade was <strong>A-</strong> and she spent approximately <strong>62 hours</strong> on development tasks.</p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="group bg-white border border-gray-200 rounded-lg p-6 hover:shadow-xl hover:border-accent transition-all duration-300 hover:-translate-y-1">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-sm text-gray-700">Developer performance grades (A-F)</span>
                </li>
                <li className="flex items-start">
            ...
            <div className="group bg-white border border-gray-200 rounded-lg p-6 hover:shadow-xl hover:border-accent transition-all duration-300 hover:-translate-y-1">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-sm text-gray-700">Magic Estimates for sprint planning</span>
                </li>
                <li className="flex items-start">
            ...
            <div className="group bg-white border border-gray-200 rounded-lg p-6 hover:shadow-xl hover:border-accent transition-all duration-300 hover:-translate-y-1">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-sm text-gray-700">Private performance grades & trends</span>
                </li>
                <li className="flex items-start">
                  <Bot className="w-5 h-5 text-secondary mt-0.5 mr-3 flex-shrink-0" />
